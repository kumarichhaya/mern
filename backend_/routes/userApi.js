...
router.put('/password/:id',async (req, res) => {
    ...
    if(user){
        ...
        if(match) {
            ...
            .then((data)=> res.send({"Success":"Password Updated"}))
...
router.put('/resetpassword/',async (req, res) => {
    ...
    .then((data)=> res.send({"Success":"Password Reset"}))
    .catch((err)=>{
        console.log(err)
...
router.put('/:id', (req, res) => {
    ...
    let id=req.params.id;
    let data={
        name:b.name,phone:b.phone,gender:b.gender,
        dob:b.dob,city:b.city,bio:b.bio}
  User.updateOne({_id:id},data)
